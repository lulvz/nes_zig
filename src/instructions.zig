...
pub const instruction_set = [_]Instruction{
    ...
    Instruction{ .opcode = .ASL, .addressing_mode = .ACCUMULATOR, .cycles = 2 },
    ...
    Instruction{ .opcode = .ROL, .addressing_mode = .ACCUMULATOR, .cycles = 2 },
    Instruction{ .opcode = .ANC, .addressing_mode = .IMMEDIATE, .cycles = 2 },
    ...
    Instruction{ .opcode = .LSR, .addressing_mode = .ACCUMULATOR, .cycles = 2 },
    ...
    Instruction{ .opcode = .ROR, .addressing_mode = .ACCUMULATOR, .cycles = 2 },
